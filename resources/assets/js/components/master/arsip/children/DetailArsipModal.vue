        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            ...
            <div class="modal-body">
                <ul class="nav nav-pills ml-auto p-2">
                    <li class="nav-item"><a class="nav-link active show" href="#tab_detail_arsip" data-toggle="tab">Detail</a></li>
                    <li class="nav-item"><a class="nav-link" href="#tab_label_arsip" data-toggle="tab">Label</a></li>
                </ul>
